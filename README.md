...
<ul>
  <li>Signup/Login</li>
  <li>Dashboard with "All Pets" and "My Pets"</li>
  <li>Features 8 pets to choose from</li>
  <li>Can adopt a pet/give up a pet</li>
  <li>Take care of a pet by:
    <ul>
      <li>Feeding it</li>
      <li>Talking to it</li>
      <li>Playing with it</li>
      <li>Washing it</li>
    </ul>
  </li>
  <li>Employs the Dialogflow API in the "Talk to Me" feature</li>
  <li>Save the Game</li>
...
<h3>Demo Video</h3>
<a href="https://www.youtube.com/watch?v=NMypXCWfVqI" target="_blank"><img src="https://img.youtube.com/vi/NMypXCWfVqI/0.jpg" alt="Pets and Friends Video Demo"/>
</a>
<hr></hr>
...
<ul>
<li> Clone this repo to your local machine using <a href="https://github.com/EthanJF/Pets-and-Friends"><code>https://github.com/EthanJF/Pets-and-Friends</code></a></li>
</ul>
</li>
</ul>
...
<ul>
<li> Create a new pull request using <a href="https://github.com/EthanJF/Pets-and-Friends/compare/"><code>https://github.com/EthanJF/Pets-and-Friends/compare/</code></a>.</li>
</ul>
<hr>
</hr>
